...
<h3 align=center>TRAIN INFORMATION </h3>
...
<br><br>Enter Source -<Select name=src ><option>select</option><option>NEW DELHI</option><option>AMBALA</option><option>PATHANKOT</option><option>JAMMU TABI</option><option>SONIPAT</option><option>PANIPAT</option><option>KURAKSHETRA</option>
...
<br><br>Enter Destination  -<Select name=dest><option>select</option><option>NEW DELHI</option><option>AMBALA</option><option>PATHANKOT</option><option>JAMMU TABI</option><option>SONIPAT</option><option>PANIPAT</option><option>KURAKSHETRA</option>
<option>SABZI MANDI</option><option>KARNAL</option><option>CHANDIGARH</option><option>LUDHIYANA</option><option>KHANNA</option><select>
...
<input type=checkbox name=thurs value='thursday'>thurs
...
if(isset($_REQUEST["submit"]))
{
       ...
       if(isset($_REQUEST["sat"]))
		...
		$str = "insert into traininfo values('$a','$b','$c','$d','$e','$f','$sun','$mon','$tue','$wed','$thurs','$fri','$sat')";
